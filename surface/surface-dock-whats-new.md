...
| 3.5 mm Audio in/out                 | Yes                                                         | Ja                                                                                                 | Yes              |
...
| Wake-on-LAN from S4/S5 sleep modes  | No                                                          | Ja                                                                                                 |          Yes        |
| Network PXE boot                    | Yes                                                         | Ja                                                                                                 |        Yes          |
| SEMM host access control            | No                                                          | Ja                                                                                                 | No               |
| SEMM port access control<sup>2</sup>          | No                                                          | Ja                                                                                                 | No               |
