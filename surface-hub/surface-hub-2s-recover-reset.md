...
1. Gerät ausschalten:
   1. Drücken Sie die Einschalttaste, während Sie die Lautstärketaste gedrückt halten.
   1. Halten Sie beide Schaltflächen gedrückt, bis Sie das Windows-Logo sehen.
   1. Lassen Sie die Power-Taste los, aber halten Sie die Lautstärke so lange gedrückt, bis die Benutzeroberfläche für die Installation beginnt.
